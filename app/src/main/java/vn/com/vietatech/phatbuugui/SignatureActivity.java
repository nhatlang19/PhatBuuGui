...
public class SignatureActivity extends AppCompatActivity {
    ...
    public final static int GET_IMAGE = 2;
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    ...
                    returnIntent.putExtra("signImage", signImage);
...
//                }
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            signImage = String.format("Signature_%d.jpg", System.currentTimeMillis());
            File photo = new File(Utils.getAlbumStorageDir("SignaturePad"), signImage);
    ...
    public boolean addSvgSignatureToGallery(String signatureSvg) {
        boolean result = false;
        try {
            signImage = String.format("Signature_%d.svg", System.currentTimeMillis());
            File svgFile = new File(Utils.getAlbumStorageDir("SignaturePad"), signImage);
